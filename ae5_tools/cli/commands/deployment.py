...
@click.option(
    "--endpoint", type=str, required=False, help="Endpoint name. If not supplied, a generated subdomain will be used."
)
...
@click.option(
    "--stop-on-error", is_flag=True, help="Stop the deployment if it fails on the first attempt. Implies --wait."
)
...
def restart(**kwargs):
    ...
    """
    result = cluster_call(
        "deployment_restart", **kwargs, prefix="Restarting deployment {ident}...", postfix="restarted."
    )
