...
class ConfigManager:
    ...
    def __init__(self):
        self._path = os.path.expanduser(get_env_var(name="AE5_TOOLS_CONFIG_DIR") or self.RC_DIR)
        self.init_path()
        self._data = {}
        self.load()
    ...
    def init_path(self):
        ...
        try:
            ...
            raise AEConfigError(msg)

    @property
    def config_path(self):
        return os.path.join(self._path, self.CONFIG_FILE)
